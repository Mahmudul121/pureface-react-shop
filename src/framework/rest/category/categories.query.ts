...
/*
  console.log(fetchedData.data.filter((d: any) => {
    if(d.name == "Haircare" || d.name == "Makeup" || d.name == "Skincare" || d.name == "Jewellery" || d.name == "Perfumes" || d.name == "Shoes"){
      return d;
    }
  }));
*/
  //return { data: fetchedData?.data };
  return { data: fetchedData.data.filter((d: any) => {
    if(d.name == "Haircare" || d.name == "Makeup" || d.name == "Skincare" || d.name == "Jewellery" || d.name == "Perfumes" || d.name == "Shoes"){
      return d;
    }
  }) };
