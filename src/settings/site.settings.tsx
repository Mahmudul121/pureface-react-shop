...
export const siteSettings = {
  name: "Purefayce",
  description:
    "Pakistan's #1 online store for organic cosmetics brings top-quality products to your doorstep through Free Delivery and Easy Returns",
  author: {
    name: "mygamemates",
    websiteUrl: "https://purefayce.com",
    address: "",
  },
  logo: {
    url: "/assets/images/purFace-logo.svg",
    alt: "Pure-fayce",
    href: "/",
    width: 95,
    height: 30,
  },
  chatButtonUrl: "https://www.facebook.com/purefayce/",
  defaultLanguage: "en",
  currency: "USD",
  site_header: {
    languageMenu: [
