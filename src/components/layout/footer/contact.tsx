			...
			<Container>
				<div className="grid grid-cols-3 py-8">
					<div>
						...
						<div className="pt-6">
							<input name="email" className="bg-gray-900 border-b-2 border-white placeholder-white" placeholder="Your Email" />
							<button className="ml-4 border-2 border-white rounded px-4">Send</button>	
						</div>
					</div>
					<div>
						<div className="flex items-center">
							<AppIcon />
							<p className="pl-1">
								Experience the PureFace mobile app
							</p>
						</div>
						<div>
						</div>
