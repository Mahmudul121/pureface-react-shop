  ...
  return (
		...
		>
			<div className="fixed top-0 w-full bg-gray-900 text-white p-3 md:flex justify-between ">
				<div>
					<p className="m-0 px-3">Delivering all over Pakistan</p>
				</div>
				<div className="flex">
			...
			<div className="innerSticky text-gray-700 body-font fixed top-12 bg-white w-full h-16 sm:h-20 lg:h-20 z-20 transition duration-200 ease-in-out">
				...
				<div className="flex text-blue-600 border-t border-slate-200 items-center justify-center mx-auto max-w-[1920px] h-12 w-full bg-white  ltr:pl-4 ltr:lg:pl-6 ltr:pr-4 ltr:lg:pr-6 rtl:pr-4 rtl:lg:pr-6 rtl:pl-4 rtl:lg:pl-6 border-b-2 border-black">
					{variant !== "modern" ?
					<HeaderSecondMenu data={menuSecond}
						className="hidden lg:flex ltr:md:ml-6 ltr:xl:ml-10 rtl:md:mr-6 rtl:xl:mr-10"
					/>
					:
					""
